...
```
verify.py layers            # print each module's layer AND FAIL on semantic misplacement
                            #   (L0 must be finance-free: no strike/vol/payoff/call-put/discount
                            #    in code — docstrings excluded). Replaces ARCHITECTURE.md.
